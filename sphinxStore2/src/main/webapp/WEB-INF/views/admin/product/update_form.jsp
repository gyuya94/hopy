	...
	<section id="two" class="wrapper style2">
		<div class="inner">
			...
			<header class="align-center">
				...
				<div class="content">
					<form action="<%=request.getContextPath()%>/admin/product/update"
							...
							<tbody >
								<tr>
									...
									<td colspan="2"><input type="text" name="productName" id="productName"
										value="${product.productName }" placeholder="productName" /></td>
								</tr>
								<tr >
									<td colspan="2">판매가격</td>
									<td colspan="2"> <input type="text" name="price" id="price"
										value="${product.price }" placeholder="price" /></td>
								</tr>
								<tr>
										...
										<div class="select-wrapper">
												<select name="selectedCategory" id="selectedCategory">
													...
													<c:forEach var="category" items="${categoryList }">
														<c:choose>
															<c:when test="${category.categoryId == product.categoryList.get(0).categoryId}">
								...
								<tr id="mainImage1">
									<td colspan="2" rowspan="2">상품 메인 이미지 
										<input type="button" value="추가"  onclick="addMainImage();" class="button alt"></td>
									<td colspan="2" ><img alt="사진 어디갔니" 
										src="<%=request.getContextPath()%>/resources/images/${product.fileNameList.get(0) }"
										width="200px"> <input type="hidden" id="orignFile" name="orignFile" value="${product.fileNameList.get(0) }"></td>
								...
								<tr>
									...
									<td colspan="2"><input type="text" name="comment" id="comment"
										value="${product.comment }" placeholder="comment" /></td>
								</tr>
								<tr>
									<td colspan="4"><textarea id="ir1" cols="10" name="ir1" class="form-control"
								style="width: 650px; height: 300px;" >${product.content }</textarea></td>
								</tr>
								
								
								
								<!-- 
								<tr><td><input type="button"  id="addItemBtn" value="옵션 추가" > </td></tr>
								<tr class="item1" >
									<td>
								...
								<td><input type="text" name="addPrice" placeholder="addPrice"/></td>
