...
@Controller
public class SelectListSupplierController {

	@Autowired
	private SupplierService supplierService;

	@RequestMapping(value = "/admin/supplier/select_list")
	public String selectListSupplier(@RequestParam("clickPage") int clickPage,
			Model model) {
